      ...
      <body>
            ...
            <ul className="d-flex align-items-center">
              <li className="nav-item dropdown pe-3">
                <a href="#" className="nav-link nav-profile d-flex align-items-center pe-0" data-bs-toggle="dropdown">
                  ...
                  <br/><br/><span className="d-none d-md-block ps-2" id="text">{username}</span>
                </a>
        ...
        {/* <!-- End Header --> */}
          ...
          <ul className="sidebar-nav" id="sidebar-nav">
            ...
            <li className="nav-item">
              <button className="nav-link collapsed" style={{ 'border': 'none', 'width': '80%' }} onClick={scheduler}>
            ...
            <li className="nav-item">
              <button className="btn btn-success" style={{ 'border': 'none', 'width': '80%' }} onClick={logOut}>
                <i ></i>
                <span>Logout</span>
              </button>
            </li>
