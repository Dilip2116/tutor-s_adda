...
export default function CourseFeesEdit() {
    ...
    function getCourses() {
        var courses = course.map(element => {return <tr key={element.course_id}>
            ...
            <td contenteditable='true'><input type="text" onChange={(e)=>{setFee(e.target.value)}} onfocus="this.value=''" placeholder="Enter Fees to Update here"/>{element.course_fee}</td>
                        ...
                        <ul className="d-flex align-items-center">
                            <li className="nav-item dropdown pe-3">
                                <a href="#" className="nav-link nav-profile d-flex align-items-center pe-0" data-bs-toggle="dropdown">
                                    ...
                                    <br /><br /> <span className="d-none d-md-block " id="text"><h3><strong>{username}</strong></h3></span>
                                </a>
                            </li>
                        </ul>
                    </nav>
