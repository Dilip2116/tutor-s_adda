      ...
      <form className="form_style">
        ...
        <div className="row">
          <div className="col-md-6 mb-4 pb-2">
            ...
            <div className="form-outline">
              <input type="text" id="sStreet" className="form-control form-control-lg" onChange={(e) => setFname(e.target.value)} required/>
          ...
          <div className="col-md-6 mb-4 pb-2">
            ...
            <div className="form-outline">
              <input type="text" id="sPincode"  className="form-control form-control-lg" onChange={(e) => setFname(e.target.value)} required />
        ...
        <div className="row">
          <div className="col-md-4 mb-4 pb-2">
            ...
            <div className="form-outline">
              <input type="text" id="sCity" className="form-control form-control-lg" onChange={(e) => setFname(e.target.value)} required/>
          ...
          <div className="col-md-4 mb-4 pb-2">
            ...
            <div className="form-outline">
              <input type="text" id="sState" className="form-control form-control-lg" onChange={(e) => setFname(e.target.value)} required/>
          ...
          <div className="col-md-4 mb-4 pb-2">
            ...
            <div className="form-outline">
              <input type="text" id="sCountry" className="form-control form-control-lg" onChange={(e) => setFname(e.target.value)} required/>
