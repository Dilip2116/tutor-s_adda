      ...
      <body>
            ...
            <ul className="d-flex align-items-center">
              <li className="nav-item dropdown pe-3">
                <a href="#" className="nav-link nav-profile d-flex align-items-center pe-0" data-bs-toggle="dropdown">
                  <img src="assets/img/profile.jpg" alt="Profile" className="rounded-circle" />
        ...
        <aside id="sidebar" className="sidebar">
          <ul className="sidebar-nav" id="sidebar-nav">
            ...
            {/* End Exam Page Nav */}
            <li className="nav-item">
              <button className="nav-link collapsed" style={{ 'border': 'none', 'width': '100%' }} onClick={examHistory}>
              ...
              <div class="col-lg-6">
                <div class="card">
                  <div class="card-body">
                    ...
                    <center>
                      <img src="assets/img/calendar.png" style={{ 'height': '100px', 'width': '100px' }}></img><br/><br/>
                      <div>
